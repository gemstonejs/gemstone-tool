...
var Gemstone = exports.Gemstone = function (_Latching) {
    ...
    (0, _createClass3.default)(Gemstone, [{
        ...
        key: "exec",
        value: function () {
            var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(name, opts) {
                var _this4 = this,
                    _commands$name$func;
                ...
                var stubLoc, dir, exists, items, _i, stat, cmd, found, commands, _found, nameSegments, i, _spec, errors, _errors, spec, out;
