    ...
    (0, _createClass3.default)(Gemstone, [{
        ...
        value: function () {
            var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(name, opts) {
                ...
                var stubLoc, dir, stat, items, _i, _stat, cmd, found, commands, _found, nameSegments, i, _spec, errors, _errors, spec, out;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 13:
                                ...
                                if (!stat.isDirectory()) dir = _path2.default.resolve(_path2.default.join(stubLoc, ".."));
                                _context2.next = 17;
                            ...
                            case 26:
                                ...
                                if (_stat !== null && _stat.isFile()) this.packagesColocated.push(_path2.default.join(dir, items[_i]));
